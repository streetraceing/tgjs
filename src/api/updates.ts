...
export class Webhook extends Updates {
    ...
    async start() {
        ...
        this.server.listen(port, () => {
            this.bot.logger.info({
                text: `Webhook server listening on port ${port} to ${url}`,
                module: 'updates',
            });
        });
    }
